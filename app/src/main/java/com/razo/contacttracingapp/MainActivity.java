...
import com.razo.contacttracingapp.config._login;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void RuntimePermission() {
        Dexter.withActivity(this).withPermissions(
                ...
                "android.permission.BLUETOOTH_ADMIN").withListener(new MultiplePermissionsListener() {
    ...
    public void showSettingsDialog() {
        ...
        builder2.setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
